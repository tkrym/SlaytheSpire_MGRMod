...
public class HakkeroChargedPower extends AbstractPower {
    public static final String POWER_ID = "MGR:HakkeroChargedPower";
    private static final String IMG = "img/power/"+POWER_ID.substring(4)+".png";
    private static final PowerStrings powerStrings = CardCrawlGame.languagePack.getPowerStrings(POWER_ID);
    public static final String NAME = powerStrings.NAME;
    public static final String[] DESCRIPTIONS = powerStrings.DESCRIPTIONS;

    public HakkeroChargedPower(int amount) {
        this.name = NAME;
        this.ID = POWER_ID;
