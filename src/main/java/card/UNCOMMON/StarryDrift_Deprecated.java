...
public class StarryDrift_Deprecated extends AbstractMGRCard
{
    public static final String ID = "MGR:StarryDrift_Deprecated";
    ...
    public AbstractCard makeCopy() {return new StarryDrift_Deprecated();}
